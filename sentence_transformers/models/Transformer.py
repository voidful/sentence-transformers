...
from sentence_transformers.models.BERT import BertModelwithMean
...
class Transformer(nn.Module):
    ...
    def __init__(self, model_name_or_path: str, max_seq_length: Optional[int] = None,
        ...
        self.auto_model = BertModelwithMean.from_pretrained(model_name_or_path, config=config, cache_dir=cache_dir)
        ...
        self.language_hidden_states = None
    ...
    def forward(self, features):
        ...
        output_states = self.auto_model(**trans_features, return_dict=False, language_layer=self.language_layer,
                                        language_hidden_states=self.language_hidden_states)
